  ...
  'dashboard': [
    ...
    },
    {
      ...
      items: [
        ...
        { title: "dashboard.sideBar.perCustomer", url: "/dashboard/warehouse/factory-sales-range-diff" },
        { title: "dashboard.sideBar.KVNWORK", url: "/dashboard/warehouse/factory-order-range-diff" },
        { title: "dashboard.sideBar.perProduct", url: "/dashboard/warehouse/product" },
        { title: "dashboard.sideBar.plan", url: "/dashboard/warehouse/scheduled" },
