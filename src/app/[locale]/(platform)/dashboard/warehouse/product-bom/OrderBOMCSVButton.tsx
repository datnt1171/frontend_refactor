...
import type { OrderBOM } from "@/types"
import { useTranslations } from "next-intl"

interface OrderBOMCSVButtonsProps {
  data: OrderBOM[]
  buttonText: string
  groupBy?: string | null
}

export function OrderBOMCSVButtons({ data, buttonText, groupBy }: OrderBOMCSVButtonsProps) {
  ...
  if (groupByColumns.includes('product_name')) {
    ...
    columns.push({ header: t('dashboard.order.orderQuantity'), key: 'order_quantity' })
  }
