...
export async function GET() {
  try {
    ...
    const response = await axios.get<PaginatedResponse<ReceivedTask>>(`${process.env.API_URL}/api/tasks/received/`, {
      headers: {
    ...
    return NextResponse.json<PaginatedResponse<ReceivedTask>>(response.data)
  } catch (error: unknown) {
