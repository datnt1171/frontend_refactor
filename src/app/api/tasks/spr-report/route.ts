...
export async function GET() {
  try {
    ...
    const response = await axios.get<PaginatedResponse<SPRReportRow>>(`${process.env.API_URL}/api/tasks/spr-report/`, {
      headers: {
    ...
    return NextResponse.json<PaginatedResponse<SPRReportRow>>(response.data)
  } catch (error: unknown) {
