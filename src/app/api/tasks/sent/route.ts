...
export async function GET() {
  try {
    ...
    const response = await axios.get<PaginatedResponse<SentTask>>(`${process.env.API_URL}/api/tasks/sent/`, {
      headers: {
    ...
    return NextResponse.json<PaginatedResponse<SentTask>>(response.data)
  } catch (error: unknown) {
